...
models += [small_expert_model, small_rl_expert_model, large_base_model, large_expert_model]
...
models += [f"dexperts-rft-lora-S{small_size}B-L{large_size}B/{alpha_strategy}" for alpha_strategy in alpha_strategies]
models += [f"dexperts-pft-S{small_size}B-L{large_size}B/{alpha_strategy}" for alpha_strategy in alpha_strategies]
models += [f"dexperts-pft-lora-S{small_size}B-L{large_size}B/{alpha_strategy}" for alpha_strategy in alpha_strategies]
